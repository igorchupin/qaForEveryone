...
// are not the common way to write this code in C#. In the next kata of this series, we gonna refactor the code and make
...
//`getSurfaceArea()` return the surface area of the `Block`
 ...
 class Block {
    ...
    public Block(int[] block) {
        ...
        this.surfaceArea = 2 * (length * height + width * height + width * length);
    }
